...
return (
   ...
   <div>
      ...
      <div className="bg-white dark:bg-gray-800 ">
         <div className="overflow-x-auto w-full dark:bg-gray-800">  
            <table className="table  w-full dark:bg-gray-800">
            {/* head */}
            <thead className="dark:bg-black text-xl">
              <tr>
                <th className="text-md font-bold">Name</th>
                <th className="text-md font-bold">Contact Info</th>
                <th className="text-md font-bold">Experience</th>
                <th className="text-md font-bold">Location</th>
                <th></th>
                <th></th>
              </tr>
            </thead>
         ...
         return (
              <tr>
                ...
                <td>
                  {instructor?.email}
                  <br/>
                  <span className="badge badge-ghost badge-sm">+880{instructor?.phone}</span>
                </td>
      ...
      <div className="grid sm:grid-cols-1 lg:grid-cols-4  md:grid-cols-2 md:gap-6  gap-4 max-w-screen-xl mx-auto">
         ...
         <div key={idx} className="">
            <div className="card bg-base-100 shadow-xl">
               <figure><img className="h-[290px] w-[500px]" src={instructor?.image} alt="" /></figure>
